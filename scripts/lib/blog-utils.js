...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .story-chip:hover .story-chip-thumb img { transform: scale(1.06); }
    .story-chip-label {
      display: -webkit-box;
      -webkit-line-clamp: 3;
    ...
    .masonry-feed { display: flex; flex-direction: column; gap: 0; }
    .masonry-band { padding: 2.25rem 0 2.75rem; }
    .masonry-band.is-empty { display: none; }
    .masonry-band.tone-paper { background: var(--paper); }
    .masonry-band.tone-sky { background: var(--sky); }
    .masonry-band.tone-mint { background: var(--mint); }
    .masonry-band.tone-rose { background: var(--rose); }
    .masonry-band-inner {
      max-width: 72rem;
      margin: 0 auto;
      padding: 0 1.5rem;
    ...
    .post-card.size-wide { grid-column: span 8; }
    .post-card.size-tall .card-media { aspect-ratio: 3 / 4; }
    .post-card.size-wide .card-media { aspect-ratio: 16 / 10; }
    .post-card.size-std .card-media { aspect-ratio: 4 / 3; }
    ...
    .card-copy { padding: 0 0.1rem 0.35rem; }
    .post-card .cat {
      display: block;
      font-size: 0.68rem;
      font-weight: 700;
    ...
    @media (max-width: 1000px) {
      .post-card, .post-card.size-wide { grid-column: span 6; }
    }
    @media (max-width: 700px) {
      .masonry-grid { grid-template-columns: 1fr; }
      .post-card, .post-card.size-wide, .post-card.size-tall { grid-column: span 1; }
      .post-card.size-tall .card-media,
      .post-card.size-wide .card-media,
      .post-card.size-std .card-media { aspect-ratio: 16 / 10; }
    }
    @media (max-width: 767px) {
      ...
      .blog-hero { padding: 1.75rem 1.1rem 1.25rem; }
      .story-strip, .blog-toolbar, .masonry-band-inner, .blog-cta.band-cta { padding-left: 1.1rem; padding-right: 1.1rem; }
